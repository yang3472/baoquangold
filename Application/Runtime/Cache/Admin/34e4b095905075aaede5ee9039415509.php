            ...
            <div class="panel-body">
                    <form class="search_form" action="" method="get">
                        <div class="form-inline" style="margin-bottom: 10px">
                            <select name="product_type" id="product_type">
                                ...
                                <?php if(is_array($productCategoryConfig)): foreach($productCategoryConfig as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if($_GET['product_type']== $vo["id"] ): ?>selected<?php endif; ?> ><?php echo ($vo["category_name"]); ?></option><?php endforeach; endif; ?>
                            </select>
                            <input class="form-control" style="width: 150px" value="<?php echo ($_GET['product_name']); ?>" id="product_name" name="product_name" placeholder="产品名称" type="text">
                            <input class="form-control" style="width: 150px" value="<?php echo ($_GET['material']); ?>" id="material" name="material" placeholder="产品材质" type="text">
                            <input class="form-control" style="width: 150px" value="<?php echo ($_GET['purpose']); ?>" id="purpose" name="purpose" placeholder="产品用途" type="text">
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                            <td>
                                <?php if(is_array($productCategoryConfig)): foreach($productCategoryConfig as $key=>$vp): if($vo["product_type"] == $vp[id]): echo ($vp["category_name"]); endif; endforeach; endif; ?>
                            </td>
                            ...
                            <td>
                                <a href="<?php echo (C("INDEX_MODE")); ?>/admin/product/edit?id=<?php echo ($vo["id"]); ?>" class="badge badge-success" style="cursor: pointer">编辑</a>
