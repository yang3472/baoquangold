            ...
            <div class="panel-body">
                <form class="search_form" action="" method="get">
                    <div class="form-inline" style="margin-bottom: 10px">
                            ...
                            <input type="email" class="form-control" placeholder="结束时间" name="end_time" id="end_time"
                                   value="<?php echo ($_GET['end_time']); ?>" style="width: 150px"  onclick="WdatePicker({maxDate:'%y-%M-%d'})">
                ...
                <table class="table table-hover table-bordered">
                    ...
                    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                        ...
                        <td>
                            <a href="<?php echo (C("INDEX_MODE")); ?>/admin/news/edit?id=<?php echo ($vo["id"]); ?>" class="badge badge-success" style="cursor: pointer">编辑</a>
