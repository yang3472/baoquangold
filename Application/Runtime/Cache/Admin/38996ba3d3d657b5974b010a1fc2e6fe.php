       ...
       -->
        ...
        <div id="content" class="span10">
            ...
            <div class="panel-body">
                <?php if($data["user_name"] == '' ): ?><h4 style="text-align: center">该用户不存在或您没有改权限</h4>
                <?php else: ?>
                <form class="form-horizontal" style="margin-top: 10px">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label type="text" style="border: none" class="form-control" ><?php echo ($data["user_name"]); ?></label>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-xlarge" id="real_name" value="<?php echo ($data["real_name"]); ?>" placeholder="请输入真实姓名" type="text">
                        </div>
                    </div>
