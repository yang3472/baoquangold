            ...
            <div class="panel-body">
                <form class="search_form" action="" method="get">
                    <div class="form-inline" style="margin-bottom: 10px">
                        ...
                        <option value="-1" <?php if($_GET['status']== '-1' ): ?>selected="selected"<?php endif; ?> >处理状态</option>
                ...
                <table class="table table-hover table-bordered">
                    ...
                    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                        ...
                        <td>
                            <?php if($vo["status"] == '1' ): ?><span style="color: #5cb85c">已处理</span>
                            <?php else: ?>
                            未处理<?php endif; ?>
                        </td>
                        <td><?php echo ($vo["create_time"]); ?></td>
                        <td>
                            <?php if($vo["status"] == '0'): ?><span class="badge badge-success" style="cursor: pointer" onclick="changeStatus(1,<?php echo ($vo["id"]); ?>)" >处理</span>
                            <?php else: ?>
                            <span class="badge badge-default">处理</span><?php endif; ?>
                            <span class="badge label-important" style="cursor: pointer" onclick="changeStatus(2,<?php echo ($vo["id"]); ?>)" >删除</span>
                        </td>
